    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav align-items-center ml-md-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" href="charts.html#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
            <i class="ni ni-ungroup"></i>
          </a>
          <div class="dropdown-menu dropdown-menu-lg dropdown-menu-dark bg-default dropdown-menu-right">
            <div class="row shortcuts px-4">
              <a href="{{ route('posts.index') }}" class="col-4 shortcut-item">
              ...
              <a href="{{ route('categories.index') }}" class="col-4 shortcut-item">
              ...
              <a href="{{ route('tags.index') }}" class="col-4 shortcut-item">
